...
public class HtmlGeneratorImpl implements HtmlGenerator{
    ...
    public String getHtmlFile(InfoForTehGroup infoForTehGroup) throws IOException {
        configuration.setDirectoryForTemplateLoading(new File("D:\\IDEA\\App_2021-2022\\TehGroupGeneratorConsumer\\src\\main\\resources\\templates"));
        ...
        String path = "D:\\IDEA\\App_2021-2022\\TehGroupGeneratorConsumer\\src\\main\\resources\\html\\" + name + ".html";
